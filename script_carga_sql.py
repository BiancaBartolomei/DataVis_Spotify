...
sql = 'select track_id, cast(data_popularidade as varchar) from spotify_db.track_popularity'
cur.execute(sql)
lista_id_track_popularity = cur.fetchall()

sql = 'select artist_id, cast(data_popularidade as varchar) from spotify_db.artist_popularity'
cur.execute(sql)
